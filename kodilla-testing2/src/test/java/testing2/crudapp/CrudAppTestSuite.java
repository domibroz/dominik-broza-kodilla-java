...
public class CrudAppTestSuite {
    public static final String BASE_URL = "https://domibroz.github.io";
    ...
    public void testTaskCleaner(String taskName) throws InterruptedException{
        while(!driver.findElement(By.xpath("//select[1]")).isDisplayed());
